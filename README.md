...
READoc consists of 2,233 documents: 1,009 in the READoc-arXiv subset and 1,224 in the READoc-GitHub subset. Each subset offers unique challenges. READoc-arXiv features complex academic structures such as formulas and tables, along with diverse multi-column layout templates. However, its heading styles are relatively simple and often follow recognizable patterns such as “1.1 Introduction”. In contrast, READoc-GitHub includes only basic elements such as paragraphs and headings, and adopts a uniform single-column layout style.
...
**Update:** We have released the ground-truth files at [https://huggingface.co/datasets/lazyc/READoc/tree/main](https://huggingface.co/datasets/lazyc/READoc/tree/main).
